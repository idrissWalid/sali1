            ...
            <div style={{ width: "100%", height: 360 }}>
              <ResponsiveContainer>
                <ComposedChart data={chartData} margin={{ top: 10, right: 20, left: 0, bottom: 10 }}>
                  ...
                  <XAxis dataKey="date" tick={{ fill: "var(--text-muted)", fontSize: 11 }} minTickGap={24} />
                  ...
                  />
                  <Legend />
                  <Area dataKey="ic" stroke="none" fill="var(--viz-7)" fillOpacity={0.15} name="Intervalle 95%" />
                  <Line type="monotone" dataKey="historique" stroke="var(--viz-1)" strokeWidth={2} dot={false} name="Historique" connectNulls />
                  <Line type="monotone" dataKey="prevue" stroke="var(--viz-2)" strokeWidth={2.5} dot={false} name="Prévision" connectNulls />
                </ComposedChart>
              </ResponsiveContainer>
            </div>
          ) : r.forecast_chart ? (
