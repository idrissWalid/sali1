...
- transformation : l'utilisateur veut MODIFIER les données elles-mêmes — renommer une colonne, corriger ou remplacer des valeurs, supprimer des lignes ou des colonnes, filtrer, dédoublonner, convertir un type, créer une colonne calculée, remplir des valeurs manquantes ; ou ANNULER une modification précédente
...
def detect_intent(message: str, model: str | None = None) -> str:
    ...
    try:
        ...
        valid = {"visualisation", "ml", "rapport", "stat_descriptive", "transformation",
                 "analyse", "series_temporelles", "conversation"}
